...
from examples.integrations.anthropic import ClaudeAdapter, ClaudeLLMService
from examples.integrations.local_llm import LocalLLMAdapter, LocalLLMService
...
class TestIntegration:
    ...
    async def test_claude_integration(self):
        ...
        with patch.dict(os.environ, {'ANTHROPIC_API_KEY': 'test-key'}):
            ...
            with patch('examples.integrations.anthropic.ClaudeAdapter._process_with_llm') as mock_process:
    ...
    async def test_local_llm_integration(self):
        ...
        # Mock the adapter for integration test
        with patch('examples.integrations.local_llm.LocalLLMAdapter._process_with_llm') as mock_process:
            mock_process.return_value = ProcessingResult(
                success=True,
                content={'extracted': 'data'},
