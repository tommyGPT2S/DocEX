...
async def test_basic_rag_service():
    ...
    # Import modules
    from examples.patterns.rag.basic_rag import RAGService, RAGResult
...
async def test_vector_database_factory():
    ...
    try:
        from examples.patterns.rag.vector_databases import VectorDatabaseFactory, FAISSVectorDatabase
...
async def test_enhanced_rag_config():
    ...
    from examples.patterns.rag.enhanced_rag import EnhancedRAGConfig
...
async def test_rag_result_serialization():
    ...
    from examples.patterns.rag.basic_rag import RAGResult
    from docex.processors.vector.semantic_search_service import SemanticSearchResult  
    from docex.document import Document
