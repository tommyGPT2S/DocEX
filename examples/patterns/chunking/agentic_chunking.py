...
from docex.processors.chunking.base import ChunkingStrategy, Chunk, ChunkingConfig
...
Select optimal chunking strategy and parameters."""
    ...
    async def _perform_chunking(
        ...
        if strategy_name == 'fixed':
            from docex.processors.chunking.fixed_size import FixedSizeChunking
            strategy = FixedSizeChunking(self.config)
        elif strategy_name == 'recursive':
            from docex.processors.chunking.recursive import RecursiveChunking
            ...
            from docex.processors.chunking.document_based import DocumentBasedChunking
